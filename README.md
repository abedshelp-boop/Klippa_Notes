...
Voice-activated note-taking app. Say **"Hey Klippa"** while listening to a podcast, lecture, or video, and it captures what was said and generates a beautifully structured note.

## How It Works

1. System audio is continuously captured via WASAPI loopback (last 2 minutes buffered)
2. Your microphone listens for the wake word "Hey Klippa" using openWakeWord
...
- **openWakeWord** — Wake word detection ("Hey Klippa")
